    ...
    <div className={`px-6 py-24 sm:py-32 lg:px-8`}>
      ...
      >
        <div className={`grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2`}>
          ...
          <Switch.Group
            as={`div`}
            className={`flex gap-x-3 sm:col-span-2`}
          >
            <div className={`flex h-6 items-center`}>
              <Switch
                checked={agreed}
                onChange={setAgreed}
                className={classNames(agreed
                  ? 'bg-primary'
                  : 'bg-gray-200', 'flex w-8 flex-none cursor-pointer rounded-full p-px ring-1 ring-inset ring-gray-900/5 transition-colors duration-200 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2')}
              >
